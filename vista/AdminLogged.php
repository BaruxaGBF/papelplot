...
<body>
  ...
  <div class="modal fade" id="EditarCategoria" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form id='formularioCategoria' method="post"
          action="../controlador/accion/Act_Categorias/act_editarcategoria.php">
          <div class="modal-body">
            <input type="hidden" name="idCategoria" value="">
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="cNombre" placeholder="Nombre" type="text" class="form-control"
                  name="nombre"></div>
            </div>
          </div>
  ...
  <div class="modal fade" id="EditarArticulo" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
    aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        <div class="modal-header">
        ...
        <form id='formularioArticulo' method="post" action="../controlador/accion/Act_Articulos/act_editarArticulo.php" enctype="multipart/form-data">
          <div class="modal-body">
            ...
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="aPrecio" placeholder="Precio" type="text" class="form-control"
                  name="precio"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="sexo col-md-8">
            ...
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="aDescripcion" placeholder="descripcion" type="text" class="form-control"
                  name="descripcion"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="aCantidad" placeholder="Cantidad" type="text" class="form-control"
                  name="existencia"></div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
      ...
      <div class="modal-content">
        ...
        <form id='formularioUsuario' method="post" action="../controlador/accion/Act_Usuarios/editarUsuario.php">
          <div class="modal-body">
            ...
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="uNombre" placeholder="PrimerNombre" type="text" class="form-control"
                  name="primerNombre"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="uNombre" placeholder="SegundoNombre" type="text" class="form-control"
                  name="segundoNombre"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="uNombre" placeholder="PrimerApellido" type="text" class="form-control"
                  name="primerApellido"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="uNombre" placeholder="SegundoApellido" type="text" class="form-control"
                  name="segundoApellido"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="uCorreo" placeholder="Correo" type="text" class="form-control"
                  name="correo"></div>
            </div>
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="sexo col-md-8">
            ...
            <div style="padding:7px 0;" class="justify-content-center row">
              <div class="col-md-8"><input id="uTelefono" placeholder="Telefono" type="text" class="form-control"
                  name="telefono"></div>
            </div>
            <div class="modal-footer">
              <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
