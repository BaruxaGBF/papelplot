...
function agregarEnTira(response){
    ...
    $.each(response, function(i) {
        articulos = '<div class="card" style="width: 18rem;"><img src="img/'+response[i].imagen+'" class="card-img-top" alt="..."><div class="card-body"><h5 class="card-title">'+response[i].nombre+'</h5><span class="badge rounded-pill bg-info text-dark">$'+response[i].precio+'</span></div><div class="card-footer"><a href="detalleArticulo.php?id='+response[i].idArticulo+'"class="btn btn-primary">Detalles</a></div></div>';
